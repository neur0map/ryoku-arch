...
run_logged $RYOKU_INSTALL/config/neovim.sh
run_logged $RYOKU_INSTALL/config/shell.sh
run_logged $RYOKU_INSTALL/config/theme.sh
run_logged $RYOKU_INSTALL/config/branding.sh
run_logged $RYOKU_INSTALL/config/git.sh
run_logged $RYOKU_INSTALL/config/gpg.sh
run_logged $RYOKU_INSTALL/config/timezones.sh
run_logged $RYOKU_INSTALL/config/increase-sudo-tries.sh
run_logged $RYOKU_INSTALL/config/increase-lockout-limit.sh
...
run_logged $RYOKU_INSTALL/config/helium-browser.sh
...
run_logged $RYOKU_INSTALL/config/hardware/network.sh
run_logged $RYOKU_INSTALL/config/hardware/set-wireless-regdom.sh
...
run_logged $RYOKU_INSTALL/config/hardware/gpu-render-primary.sh
...
run_logged $RYOKU_INSTALL/config/hardware/fix-yt6801-ethernet-adapter.sh
run_logged $RYOKU_INSTALL/config/hardware/fix-synaptic-touchpad.sh
run_logged $RYOKU_INSTALL/config/hardware/fix-tuxedo-backlight.sh
