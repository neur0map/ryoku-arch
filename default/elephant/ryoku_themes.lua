--
-- Dynamic Ryoku Theme Menu for Elephant/Walker
--
Name = "ryokuthemes"
NamePretty = "Ryoku Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/ryoku/themes"
  local ryoku_path = os.getenv("RYOKU_PATH") or (os.getenv("HOME") .. "/.local/share/ryoku")
  local default_theme_dir = ryoku_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "ryoku-theme-set " .. theme_name,
            },
          })
        end
      end
