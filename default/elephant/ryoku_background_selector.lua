Name = "ryokuBackgroundSelector"
NamePretty = "Ryoku Background Selector"
Cache = false
...
function GetEntries()
  ...
  local theme_name_file = io.open(home .. "/.config/ryoku/current/theme.name", "r")
  ...
  if theme_name then
    table.insert(dirs, home .. "/.config/ryoku/backgrounds/" .. theme_name)
  end
      ...
      for background in handle:lines() do
        ...
        if filename and not seen[filename] then
          ...
          table.insert(entries, {
            ...
            Value = background,
            Actions = {
              activate = "ryoku-theme-bg-set " .. ShellEscape(background),
            },
            Preview = background,
            PreviewType = "file",
          })
