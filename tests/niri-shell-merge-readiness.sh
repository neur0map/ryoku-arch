...
assert_not_contains shell/services/ShellUpdates.qml 'ryoku-doctor update' "shell update failures should use the short doctor command"
assert_not_contains shell/services/ShellUpdates.qml '\./setup doctor|ryoku-shell doctor' "shell update UI should only advertise ryoku-doctor"
assert_not_contains shell/setup '\./setup doctor' "setup help/status text should only advertise ryoku-doctor"
assert_not_contains shell/scripts/ryoku-shell 'ryoku-shell doctor[[:space:]]+Health checks' "ryoku-shell help should not advertise a second doctor entry point"
assert_contains shell/scripts/ryoku-shell 'ryoku-doctor' "ryoku-shell compatibility path should point users to ryoku-doctor"
...
assert_contains shell/settings.qml 'ExtrasConfig\.qml' "Settings app should expose the Extras profiles page"
