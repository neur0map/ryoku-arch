...
assert_asset_references_are_updated() {
  ...
  assert_contains "shell/modules/controlcenter/Wrapper.qml" 'aboutPage\.info\.version' \
    "Control center About page should display the version reported by the helper"
}
