...
Item {
    ...
    Rectangle {
        ...
        visible: btn.primary
        radius: btn.radius
        color: hover.hovered ? Qt.rgba(btn.accent.r, btn.accent.g, btn.accent.b, 0.12) : "transparent"
        border.width: 1
    ...
    Rectangle {
        ...
        border.width: 1
        border.color: hover.hovered ? btn.accent : Theme.line
        Behavior on color { ColorAnimation { duration: Theme.quick } }
    ...
    Row {
        ...
        Icon {
            ...
            size: 14
            weight: 1.8
            tint: btn.primary ? (hover.hovered ? Qt.lighter(btn.accent, 1.25) : btn.accent) : (hover.hovered ? Theme.bright : Theme.cream)
        ...
        Text {
            anchors.verticalCenter: parent.verticalCenter
            text: btn.label
            color: btn.primary ? (hover.hovered ? Qt.lighter(btn.accent, 1.25) : btn.accent) : (hover.hovered ? Theme.bright : Theme.cream)
