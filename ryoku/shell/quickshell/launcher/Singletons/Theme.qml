...
Singleton {
    ...
    readonly property color cardTop:  Config.matchWallpaper ? Wallust.base : "#1a1b26"
    readonly property color cardBot:  Config.matchWallpaper ? Wallust.deep : "#16161e"
    readonly property color border:   Config.matchWallpaper ? Wallust.line : "#2f3549"
    readonly property color shadow:   Qt.rgba(0, 0, 0, 0.62)
    readonly property color tileBg:   Config.matchWallpaper ? Wallust.elevated : "#1f2335"
