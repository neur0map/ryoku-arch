...
func defaultOverrides() Overrides {
	return Overrides{
		Appearance: Appearance{
			...
			FollowWallpaper: true, ActiveBorder: "#e0563b", InactiveBorder: "#313a4d",
		},
		Input: Input{
...
func writeGeneratedLua(o Overrides) error {
	return atomicWrite(generatedLuaPath(), []byte(genLua(o)), 0o644)
}
...
func genLua(o Overrides) string {
	var b strings.Builder
	b.WriteString(luaHeader)

	if cfg := genConfig(o); cfg != "" {
		b.WriteString(cfg)
	}
