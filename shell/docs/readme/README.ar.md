...
إذا شي ما اشتغل، `ryoku-doctor` يصلح أغلب الأشياء. إذا ما نفع، الـ Discord نشط. لا تتوقع سوفتوير مصقول، هذا rice شخص واحد عجب ناس ثانيين.
...
ryoku-doctor                     # تشخيص وإصلاح تلقائي
...
ryoku-doctor                  # تشخيص وإصلاح المشاكل الشائعة تلقائياً
