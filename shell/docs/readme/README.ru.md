...
Если что-то не работает, `ryoku-doctor` чинит большинство проблем. Discord активный, если это не поможет. Не жди отполированного софта — это рис одного человека, который понравился другим.
...
ryoku-doctor                     # автодиагностика и исправление
...
ryoku-doctor                  # автодиагностика и исправление типичных проблем
