    ...
    delegate: Item {
      ...
      Loader {
        ...
        sourceComponent: PanelWindow {
          ...
          WlrLayershell.namespace: "ryoku-dock-peek-" + (screen?.name || "unknown")
      ...
      Loader {
        ...
        sourceComponent: PanelWindow {
          ...
          WlrLayershell.namespace: "ryoku-dock-indicator-" + (screen?.name || "unknown")
      ...
      Loader {
        ...
        sourceComponent: PanelWindow {
          ...
          WlrLayershell.namespace: "ryoku-dock-" + (screen?.name || "unknown")
