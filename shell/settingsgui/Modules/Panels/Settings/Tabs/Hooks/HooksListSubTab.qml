...
ColumnLayout {
  ...
  HookRow {
    label: I18n.tr("panels.hooks.ryoku-started-label")
    description: I18n.tr("panels.hooks.ryoku-started-description")
    value: Settings.data.hooks.startup
    onEditClicked: openEdit(label, description, I18n.tr("panels.hooks.ryoku-started-placeholder"), value, newValue => {
