...
Item {
  ...
  ColumnLayout {
    ...
    // Airplane Mode — not available in ryoku (no BluetoothService / airplane mode backend)
    // TODO: wire airplane mode to ryoku (no BluetoothService in ryoku; NetworkService.airplaneModeEnabled always false)
    NBox {
      id: miscSettingsBox
      visible: false
      Layout.fillWidth: true
