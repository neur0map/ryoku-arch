...
import qs.settingsgui.Modules.MainScreen.Backgrounds
...
Variants {
  ...
  delegate: Loader {
    ...
    sourceComponent: PanelWindow {
      ...
      WlrLayershell.namespace: "ryoku-launcher-overlay-" + (screen?.name || "unknown")
      ...
      Item {
        ...
        Shape {
          ...
          ShapePath {
            strokeWidth: -1
            fillColor: Qt.alpha(Color.mSurface, Color.adaptiveOpacity(GlobalConfig.ui.panelBackgroundOpacity))
