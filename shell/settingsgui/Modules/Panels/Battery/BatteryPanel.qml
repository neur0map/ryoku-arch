  ...
  panelContent: Item {
    ...
    ColumnLayout {
      ...
      NBox {
        ...
        visible: showPowerProfiles || showPerformanceMode
        ...
        ColumnLayout {
          ...
          NDivider {
            Layout.fillWidth: true
            visible: showPowerProfiles && PowerProfileService.available && showPerformanceMode
          }
          ...
          RowLayout {
            ...
            NIcon {
              ...
              pointSize: Style.fontSizeL
              color: PowerProfileService.performanceMode ? Color.mPrimary : Color.mOnSurfaceVariant
            }
