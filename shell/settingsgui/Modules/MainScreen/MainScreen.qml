...
import qs.settingsgui.Modules.Bar
import qs.settingsgui.Modules.Bar.Extras
import qs.settingsgui.Modules.Panels.Audio
import qs.settingsgui.Modules.Panels.Battery
import qs.settingsgui.Modules.Panels.Bluetooth
import qs.settingsgui.Modules.Panels.Brightness
import qs.settingsgui.Modules.Panels.Changelog
import qs.settingsgui.Modules.Panels.Clock
import qs.settingsgui.Modules.Panels.ControlCenter
import qs.settingsgui.Modules.Panels.Dock
import qs.settingsgui.Modules.Panels.Launcher
import qs.settingsgui.Modules.Panels.Media
import qs.settingsgui.Modules.Panels.Network
import qs.settingsgui.Modules.Panels.NotificationHistory
import qs.settingsgui.Modules.Panels.Plugins
import qs.settingsgui.Modules.Panels.SessionMenu
import qs.settingsgui.Modules.Panels.Settings
import qs.settingsgui.Modules.Panels.SetupWizard
import qs.settingsgui.Modules.Panels.SystemStats
import qs.settingsgui.Modules.Panels.Tray
import qs.settingsgui.Modules.Panels.Wallpaper
...
PanelWindow {
  ...
  WlrLayershell.namespace: "ryoku-background-" + (screen?.name || "unknown")
