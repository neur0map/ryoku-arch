...
Singleton {
  ...
  readonly property string checkCalendarAvailableScript: Quickshell.shellDir + "/settingsgui" + '/Scripts/python/src/calendar/check-calendar.py'
  readonly property string listCalendarsScript: Quickshell.shellDir + "/settingsgui" + '/Scripts/python/src/calendar/list-calendars.py'
  readonly property string calendarEventsScript: Quickshell.shellDir + "/settingsgui" + '/Scripts/python/src/calendar/calendar-events.py'
