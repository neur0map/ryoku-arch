...
Singleton {
  ...
  readonly property string _widgetsDir: Quickshell.shellDir + "/settingsgui" + "/Modules/DesktopWidgets/Widgets/"
  ...
  function openWidgetSettings(screen, widgetIndex, widgetId, widgetData) {
    ...
    var component = Qt.createComponent(Quickshell.shellDir + "/settingsgui" + "/Modules/Panels/Settings/DesktopWidgets/DesktopWidgetSettingsDialog.qml");
