...
Singleton {
  ...
  property string historyFile: Quickshell.env("RYOKU_NOTIF_HISTORY_FILE") || (Settings.cacheDir + "notifications.json")
  ...
  function getNotificationSoundFile(urgency) {
    ...
    const defaultSoundFile = Quickshell.shellDir + "/settingsgui" + "/Assets/Sounds/notification-generic.wav";
