...
declare -gA IPC_TARGET_DESC=(
  ...
  [settings]="Open the resident settings overlay. GUI config so you don't have to edit JSON like it's 2005."
...
declare -gA IPC_TARGET_FUNCTIONS=(
  ...
  [shellUpdate]="toggle open close check refresh setChannel performUpdate dismiss undismiss diagnose"
...
declare -gA IPC_FUNCTION_DESC=(
  ...
  ["settings:open"]="Open settings overlay"
  ...
  ["shellUpdate:refresh"]=""
  ["shellUpdate:setChannel"]="Set the Ryoku update channel"
