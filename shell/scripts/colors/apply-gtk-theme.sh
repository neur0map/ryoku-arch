...
generate_pywalfox() {
    # Generate pywalfox-compatible JSON from Ryoku palette for Firefox theming
...
cat > "$GTK3_CSS" << EOF
/*
 * GTK Colors - Generated with Ryoku theming
...
cat > "$GTK4_CSS" << EOF
/*
 * GTK4/libadwaita Colors — Generated by Ryoku theming
