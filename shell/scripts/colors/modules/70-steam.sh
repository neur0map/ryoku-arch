...
:root {
  ...
  --md-sys-color-primary-fixed: rgb($(read_token primary_fixed "$(read_token primary)"));
  --md-sys-color-primary-fixed-dim: rgb($(read_token primary_fixed_dim "$(read_token primary_container)"));
  --md-sys-color-on-primary-fixed: rgb($(read_token on_primary_fixed "$(read_token on_primary)"));
  ...
  --md-sys-color-secondary-fixed: rgb($(read_token secondary_fixed "$(read_token secondary)"));
  --md-sys-color-secondary-fixed-dim: rgb($(read_token secondary_fixed_dim "$(read_token secondary_container)"));
  --md-sys-color-on-secondary-fixed: rgb($(read_token on_secondary_fixed "$(read_token on_secondary)"));
  ...
  --md-sys-color-tertiary-fixed: rgb($(read_token tertiary_fixed "$(read_token tertiary)"));
  --md-sys-color-tertiary-fixed-dim: rgb($(read_token tertiary_fixed_dim "$(read_token tertiary_container)"));
  --md-sys-color-on-tertiary-fixed: rgb($(read_token on_tertiary_fixed "$(read_token on_tertiary)"));
...
deploy_millennium_material() {
  ...
  command -v jq >/dev/null 2>&1 || { log_module "jq not installed; cannot generate Steam Matugen CSS"; return 1; }
...
main() {
  ...
  [[ $enabled == "true" || ${RYOKU_STEAM_THEME_FORCE:-0} == "1" ]] || exit 0
