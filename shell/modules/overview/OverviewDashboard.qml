...
Item {
        ...
        Flickable {
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    // Hero: compact cluster + flex spacer + trailing refresh.
                    RowLayout {
                        Layout.fillWidth: true
                        spacing: 14
    ...
    component WeatherChip: Rectangle {
        ...
        color: root.angelStyle ? ColorUtils.transparentize(root.colPrimary, 0.78)
            ...
            : Appearance.colors.colSecondaryContainer
        border.width: root.ryokuStyle ? 1 : 0
        border.color: root.ryokuStyle ? Appearance.ryoku.colBorderSubtle : "transparent"
