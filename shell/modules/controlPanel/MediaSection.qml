...
Item {
    ...
    Rectangle {
        ...
        radius: Appearance.angelEverywhere ? Appearance.angel.roundingNormal
             : root.ryokuEverywhere ? Appearance.ryoku.roundingNormal : Appearance.rounding.normal
        color: Appearance.angelEverywhere ? "transparent"
             : root.ryokuEverywhere ? Appearance.ryoku.colLayer1 
        ...
        border.color: Appearance.angelEverywhere ? "transparent"
                    : root.ryokuEverywhere ? Appearance.ryoku.colBorder : "transparent"
        clip: true
        ...
        Image {
            ...
            smooth: true
            mipmap: true
            opacity: root.ryokuEverywhere ? 0.15 : (root.auroraEverywhere ? 0.25 : 0.5)
            visible: root.displayedArtFilePath !== ""

            layer.enabled: Appearance.effectsEnabled
            layer.effect: MultiEffect {
                blurEnabled: true
                blur: root.ryokuEverywhere ? 0.3 : 0.15
                blurMax: 16
                saturation: root.ryokuEverywhere ? 0.1 : 0.3
            }
        }
        ...
        Rectangle {
            anchors.fill: parent
            visible: !root.ryokuEverywhere && !root.auroraEverywhere
            gradient: Gradient {
                ...
                RowLayout {
                    ...
                    RippleButton {
                        ...
                        colBackgroundHover: Appearance.angelEverywhere ? Appearance.angel.colGlassCardHover
                            : root.ryokuEverywhere ? Appearance.ryoku.colLayer2Hover : ColorUtils.transparentize(root.blendedColors?.colLayer1 ?? Appearance.colors.colLayer1, 0.5)
                        colRipple: Appearance.angelEverywhere ? Appearance.angel.colGlassCardActive
                            : root.ryokuEverywhere ? Appearance.ryoku.colLayer2Active : (root.blendedColors?.colLayer1Active ?? Appearance.colors.colLayer1Active)
