...
PopupWindow {
    ...
    MouseArea {
        ...
        GlassBackground {
            ...
            ryokuColor: Appearance.ryoku?.colLayer2 ?? Appearance.colors.colSurfaceContainer
            auroraTransparency: Appearance.aurora?.popupTransparentize ?? 0.1
            radius: Appearance.angelEverywhere ? Appearance.angel.roundingNormal
                : Appearance.ryokuEverywhere ? (Appearance.ryoku?.roundingNormal ?? 12) : Appearance.rounding.normal
            border.width: 1
            border.color: Appearance.angelEverywhere ? Appearance.angel.colBorder
                : Appearance.ryokuEverywhere 
                ? (Appearance.ryoku?.colBorder ?? "transparent")
