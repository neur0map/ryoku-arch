            ...
            Row {
                ...
                BigRecorderButton {
                    ...
                    onClicked: {
                        ...
                        Quickshell.execDetached(["sh", "-lc", "$HOME/.local/bin/ryoku-shell ipc picker openFreeze"]);
                    }
                }
                ...
                BigRecorderButton {
                    ...
                    onClicked: {
                        GlobalStates.overlayOpen = false;
                        RecorderStatus.start(["--with-desktop-audio"]);
                    }
                }
                ...
                BigRecorderButton {
                    ...
                    onClicked: {
                        GlobalStates.overlayOpen = false;
                        RecorderStatus.start(["--fullscreen", "--with-desktop-audio"]);
                    }
                }
    ...
    component RecorderGameModeSection: ColumnLayout {
        ...
        Item {
            ...
            ColumnLayout {
                ...
                GameModeToggle {
                    text: Translation.tr("Disable Hyprland animations")
