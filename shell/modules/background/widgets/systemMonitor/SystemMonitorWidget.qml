...
AbstractBackgroundWidget {
    ...
    readonly property int _innerMargin: Appearance.angelEverywhere || Appearance.ryokuEverywhere ? 6 : 2
    ...
    readonly property color tempColor: Appearance.ryokuEverywhere ? Appearance.ryoku.colError
