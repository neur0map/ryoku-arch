...
GroupButton {
    ...
    colBackgroundToggled: Appearance.angelEverywhere ? ColorUtils.transparentize(Appearance.angel.colPrimary, 0.45)
        : Appearance.ryokuEverywhere ? Appearance.ryoku.colPrimaryContainer : Appearance.colors.colPrimary
    colBackgroundToggledHover: Appearance.angelEverywhere ? ColorUtils.transparentize(Appearance.angel.colPrimaryHover, 0.35)
        : Appearance.ryokuEverywhere ? Appearance.ryoku.colPrimaryContainerHover : Appearance.colors.colPrimaryHover
    ...
    contentItem: Item {
        ...
        MaterialSymbol {
            ...
            color: Appearance.angelEverywhere
                ...
                ? (button.toggled ? Appearance.ryoku.colOnPrimaryContainer : Appearance.ryoku.colText)
