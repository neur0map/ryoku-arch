...
ColumnLayout {
    ...
    ContentSubsection {
        ...
        StyledText {
            Layout.fillWidth: true
            text: Translation.tr("Controls how see-through each UI layer is. Higher values make surfaces more transparent.")
            font.pixelSize: Appearance.font.pixelSize.smallest
            color: Appearance.colors.colSubtext
            wrapMode: Text.WordWrap
            opacity: 0.7
        ...
        SliderRow {
            ...
            icon: "dock_to_bottom"
            description: Translation.tr("Bar, sidebar, and main panel backgrounds")
        ...
        SliderRow {
            ...
            icon: "crop_square"
            description: Translation.tr("Settings cards, groups, and internal containers")
        ...
        SliderRow {
            ...
            icon: "open_in_new"
            description: Translation.tr("Context menus and dropdown overlays")
        ...
        SliderRow {
            ...
            icon: "layers"
            description: Translation.tr("General layer glass for surface backgrounds")
