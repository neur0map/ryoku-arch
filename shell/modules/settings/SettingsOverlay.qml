...
Scope {
    ...
    property var overlaySearchIndex: [
        ...
        { pageIndex: 4, pageName: overlayPages[4].name, section: Translation.tr("Global Style"), label: Translation.tr("Ryoku"), description: Translation.tr("TUI-inspired style with accent borders"), keywords: ["ryoku-shell", "tui", "terminal", "borders", "style", "minimal"] },
        ...
        { pageIndex: 7, pageName: overlayPages[7].name, section: Translation.tr("Applications"), label: Translation.tr("Default applications"), description: Translation.tr("Terminal, editor, browser, network and account commands"), keywords: ["apps", "applications", "terminal", "editor", "text", "neovim", "zed", "browser", "network", "bluetooth", "account", "default"] },
        // Advanced (page 8)
