...
MaterialSymbol {
    ...
    Rectangle {
        ...
        color: Appearance.ryokuEverywhere ? Appearance.ryoku.colPrimary : Appearance.colors.colOnLayer0
        z: 1
        ...
        StyledText {
            ...
            color: Appearance.ryokuEverywhere ? Appearance.ryoku.colOnPrimary : Appearance.colors.colLayer0
