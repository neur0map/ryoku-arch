...
Rectangle {
    ...
    property real borderRadius: Appearance.ryokuEverywhere ? Appearance.ryoku.roundingSmall : Appearance.rounding.verysmall
    ...
    color: Appearance.ryokuEverywhere ? Appearance.ryoku.colBorderMuted : Appearance.colors.colSurfaceContainerHigh
    ...
    Rectangle {
        ...
        color: Appearance.ryokuEverywhere ? Appearance.ryoku.colLayer2 : Appearance.colors.colSurfaceContainer
