...
Singleton {
    ...
    readonly property var synthwave84Colors: ({
        ...
        m3outline: "#616eb3", // Boosted form #495495 for Ryoku borders
    ...
    function generateColorsJson(c) {
        ...
        // reach disk and external apps to read stale wallpaper colors.
    ...
    function _doWriteGeneratedFiles(colorsJson, paletteJson, appPaletteJson, terminalJson, themeMeta, scss, chromiumRgb) {
        ...
        // Generated JSON/SCSS use double quotes and hex colors only, so single-quoting is safe.
