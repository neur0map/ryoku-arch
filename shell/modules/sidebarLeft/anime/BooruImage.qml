...
Button {
    ...
    background: Rectangle {
        ...
        implicitHeight: root.rowHeight
        radius: imageRadius
        color: root.showBackground ? (Appearance.angelEverywhere ? Appearance.angel.colGlassCard : Appearance.ryokuEverywhere ? Appearance.ryoku.colLayer2 : (Appearance.auroraEverywhere ? Appearance.aurora.colElevatedSurface : Appearance.colors.colLayer2)) : "transparent"
    }
