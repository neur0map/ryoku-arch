...
import qs.noctalia.Commons.Migrations
  ...
  */
  ...
  function generateDefaultSettings() {
    try {
      ...
      var defaultPath = Quickshell.shellDir + "/noctalia" + "/Assets/settings-default.json";
  ...
  function generateWidgetDefaultSettings() {
    try {
      ...
      var defaultPath = Quickshell.shellDir + "/noctalia" + "/Assets/settings-widgets-default.json";
