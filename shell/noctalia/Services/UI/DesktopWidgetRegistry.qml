...
import qs.noctalia.Modules.DesktopWidgets.Widgets
...
Singleton {
  ...
  readonly property string _widgetsDir: Quickshell.shellDir + "/noctalia" + "/Modules/DesktopWidgets/Widgets/"
  ...
  function openWidgetSettings(screen, widgetIndex, widgetId, widgetData) {
    ...
    var component = Qt.createComponent(Quickshell.shellDir + "/noctalia" + "/Modules/Panels/Settings/DesktopWidgets/DesktopWidgetSettingsDialog.qml");
