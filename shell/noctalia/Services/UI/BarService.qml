...
Singleton {
  ...
  function openWidgetSettings(screen, section, index, widgetId, widgetData) {
    ...
    var component = Qt.createComponent(Quickshell.shellDir + "/noctalia" + "/Modules/Panels/Settings/Bar/BarWidgetSettingsDialog.qml");
  ...
  function openPluginSettings(screen, pluginManifest) {
    ...
    var component = Qt.createComponent(Quickshell.shellDir + "/noctalia" + "/Widgets/NPluginSettingsPopup.qml");
