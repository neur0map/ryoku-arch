...
Singleton {
  ...
  readonly property string templateApplyScript: Quickshell.shellDir + "/noctalia" + '/Scripts/bash/template-apply.sh'
  readonly property string gtkRefreshScript: Quickshell.shellDir + "/noctalia" + '/Scripts/python/src/theming/gtk-refresh.py'
  readonly property string kdeApplyScript: Quickshell.shellDir + "/noctalia" + '/Scripts/python/src/theming/kde-apply-scheme.py'
  readonly property string vscodeHelperScript: Quickshell.shellDir + "/noctalia" + '/Scripts/python/src/theming/vscode-helper.py'
  ...
  readonly property var applications: [
    ...
    },
    {
      ...
      "postProcess": () => `cp --update=none ${Quickshell.shellDir + "/noctalia"}/Assets/noctalia.svg ~/.local/share/vicinae/themes/noctalia.svg && ${templateApplyScript} vicinae`
    },
    {
      "id": "walker",
      "name": "Walker",
