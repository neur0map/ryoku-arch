...
class HyprExtras : public QObject {
    ...
    Q_PROPERTY(ryoku::internal::hypr::HyprDevices* devices READ devices CONSTANT)
    Q_PROPERTY(bool luaMode READ luaMode CONSTANT)
...
public:
    ...
    Q_INVOKABLE void evalLua(const QString& lua);
