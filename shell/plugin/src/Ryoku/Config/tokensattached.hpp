...
class Tokens : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
    ...
    Q_PROPERTY(const ryoku::config::AppearanceRounding* rounding READ rounding NOTIFY sourceChanged)
    Q_PROPERTY(const ryoku::config::AppearanceSpacing* spacing READ spacing NOTIFY sourceChanged)
    Q_PROPERTY(const ryoku::config::AppearancePadding* padding READ padding NOTIFY sourceChanged)
    Q_PROPERTY(const ryoku::config::AppearanceFont* font READ font NOTIFY sourceChanged)
    Q_PROPERTY(const ryoku::config::AppearanceTransparency* transparency READ transparency NOTIFY sourceChanged)
    Q_PROPERTY(const ryoku::config::SizeTokens* sizes READ sizes NOTIFY sourceChanged)
    Q_PROPERTY(const ryoku::config::AnimTokens* anim READ anim NOTIFY sourceChanged)
