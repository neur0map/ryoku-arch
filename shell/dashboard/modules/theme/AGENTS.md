...
| File | Type | Role |
|------|------|------|
| `Colors.qml` | Singleton | Watches `~/.cache/ryoku/dashboard/colors.json`. Provides reactive palette (`primary`, `secondary`, `surface`, `onSurface`, etc.) |
...
| Task | Location | Notes |
|------|----------|-------|
| **Change colors** | `Colors.qml` | Modify `~/.cache/ryoku/dashboard/colors.json` or change color preset |
