    ...
    FloatingWindow {
        ...
        Item {
            ...
            QtObject {
                ...
                readonly property color inkDim: "#9a948c"
                readonly property color inkMuted: "#7a756f"
                readonly property color inkFaint: "#5e5a55"
            ...
            ListModel {
                ...
                ListElement { sec: "FRAME"; key: "frame";  n: "Enable frame";        w: "Draw the rounded border around the screen"; v: "1"; d: "1"; u: ""; src: "shell.json"; ctl: "sw" }
                ListElement { sec: "FRAME"; key: "border"; n: "Border thickness";    w: "How far the frame intrudes on each edge";   v: "57"; d: "24"; u: "px"; src: "shell.json"; ctl: "step"; lo: 0; hi: 120 }
                ListElement { sec: "FRAME"; key: "radius"; n: "Frame radius";        w: "Corner rounding of the frame";              v: "2"; d: "10"; u: "px"; src: "shell.json"; ctl: "step"; lo: 0; hi: 40 }
                ListElement { sec: "FRAME"; key: "blur";   n: "Blur behind popouts"; w: "Compositor blur under popout surfaces";     v: "0"; d: "1"; u: ""; src: "shell.json"; ctl: "sw" }

                ListElement { sec: "NOTIFICATIONS"; key: "corner"; n: "Toast corner"; w: "Which corner notifications grow from"; v: "TOP RIGHT"; d: "TOP RIGHT"; u: ""; src: "shell.json"; ctl: "seg"; opts: "TOP LEFT,TOP RIGHT,BOTTOM RIGHT,BOTTOM LEFT" }
                ListElement { sec: "NOTIFICATIONS"; key: "opac";   n: "Toast opacity"; w: "Surface opacity over the wallpaper";  v: "100"; d: "100"; u: "%"; src: "shell.json"; ctl: "slid"; lo: 20; hi: 100 }
                ListElement { sec: "NOTIFICATIONS"; key: "dwell";  n: "Dwell";         w: "How long a toast rests before it goes"; v: "6"; d: "6"; u: "s"; src: "shell.json"; ctl: "step"; lo: 1; hi: 30 }

                // 2 options — the real skins, carried from the credited shells
                ListElement { sec: "BAR"; key: "barskin"; n: "Bar skin";  w: "Module vocabulary of the resting bar"; v: "NOCTALIA"; d: "NOCTALIA"; u: ""; src: "shell.json"; ctl: "seg"; opts: "NOCTALIA,CAELESTIA" }
                // 3 options — the most common shape in the Hub (21 controls)
                ListElement { sec: "BAR"; key: "edge";    n: "Island edge"; w: "Which frame edge the bar rides";      v: "TOP"; d: "TOP"; u: ""; src: "shell.json"; ctl: "seg"; opts: "TOP,BOTTOM,HIDDEN" }
                ListElement { sec: "BAR"; key: "along";   n: "Alignment";   w: "Where the island sits along its edge"; v: "CENTRE"; d: "CENTRE"; u: ""; src: "shell.json"; ctl: "seg"; opts: "START,CENTRE,END" }
                // set membership — NOT a choice. 4 of 7 selected.
                ListElement { sec: "BAR"; key: "mods";    n: "Island modules"; w: "Which modules the bar carries. Order follows the strip."; v: "workspaces,clock,date,media"; d: "workspaces,clock,date,media"; u: ""; src: "shell.json"; ctl: "multi" }
                ListElement { sec: "BAR"; key: "iradius"; n: "Island radius"; w: "Corner rounding of the bar itself"; v: "17"; d: "17"; u: "px"; src: "shell.json"; ctl: "step"; lo: 0; hi: 30 }

                // 25 options — a catalogue. a segmented cannot hold this.
                ListElement { sec: "TYPE"; key: "uifont";   n: "UI font";   w: "Body and label face across the shell"; v: "Space Grotesk"; d: "Space Grotesk"; u: ""; src: "shell.json"; ctl: "pick" }
                ListElement { sec: "TYPE"; key: "monofont"; n: "Mono font"; w: "Numerals, code and technical labels"; v: "JetBrains Mono"; d: "Space Mono"; u: ""; src: "shell.json"; ctl: "pick" }

                ListElement { sec: "VISUALISER"; key: "viz";   n: "Visualiser"; w: "Audio spectrum on the desktop"; v: "0"; d: "0"; u: ""; src: "visualizer.json"; ctl: "sw" }
                // 7 options — too many to segment, few enough to show as chips
                ListElement { sec: "VISUALISER"; key: "vstyle"; n: "Style";   w: "How the spectrum is drawn"; v: "Bars"; d: "Bars"; u: ""; src: "visualizer.json"; ctl: "chips" }
                ListElement { sec: "VISUALISER"; key: "gain";  n: "Gain";     w: "Input sensitivity of the spectrum"; v: "62"; d: "50"; u: "%"; src: "visualizer.json"; ctl: "slid"; lo: 0; hi: 100 }
            }
            ...
            Component {
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        color: tk.inkFaint; font.family: tk.mono; font.pixelSize: 8
                        opacity: hh.hovered ? 1 : 0.55
                    ...
                    Column {
                        ...
                        anchors.right: cell.wide ? undefined : parent.right
                        anchors.rightMargin: tk.s3
                        width: cell.wide ? cell.width * 0.44 : undefined
                        spacing: 0
                        Text { text: cell.m ? cell.m.n.toUpperCase() : ""; color: tk.inkMuted; font.family: tk.ui; font.pixelSize: 9; font.weight: Font.Medium; font.letterSpacing: 1.4 }
                        Row {
                            spacing: 4
                            visible: cell.m && cell.m.ctl !== "multi" && cell.m.ctl !== "chips"
                            Text {
                        ...
                        Text {
                            width: cell.wide ? cell.width * 0.44 - tk.s4 : cell.width - tk.s4 - tk.s3
                            text: cell.m ? cell.m.w : ""
                            color: tk.inkMuted; font.family: tk.ui; font.pixelSize: 11
                    ...
                    Item {
                        ...
                        anchors.leftMargin: tk.s4; anchors.rightMargin: tk.s3
                        anchors.bottom: cell.wide ? undefined : parent.bottom
                        anchors.bottomMargin: tk.s3
                        anchors.verticalCenter: cell.wide ? parent.verticalCenter : undefined
                        height: 26
                ...
                Rectangle {
                    ...
                    Canvas {
                        ...
                        onPaint: {
                            ...
                            if (edge !== "HIDDEN") {
                                var n = mods.split(",").filter(function (s) { return s.length }).length;
                                var bwid = Math.max(40, 26 + n * 20);
                                var bx = ix + (iw - bwid) / 2;
                                var by = edge === "BOTTOM" ? iy + ih - 8 - 14 : iy + 8;
                                c.fillStyle = "rgba(194,185,176,0.18)";
                                var brr = Math.min(7, irad / 30 * 7);
                                c.beginPath();
                                c.moveTo(bx + brr, by); c.lineTo(bx + bwid - brr, by);
                                c.quadraticCurveTo(bx + bwid, by, bx + bwid, by + brr);
                                c.lineTo(bx + bwid, by + 14 - brr); c.quadraticCurveTo(bx + bwid, by + 14, bx + bwid - brr, by + 14);
                                c.lineTo(bx + brr, by + 14); c.quadraticCurveTo(bx, by + 14, bx, by + 14 - brr);
                                c.lineTo(bx, by + brr); c.quadraticCurveTo(bx, by, bx + brr, by);
                                c.closePath(); c.fill();
                                c.fillStyle = "rgba(194,185,176,0.55)";
                                c.fillRect(bx + 7, by + 5, 5, 5);
                                for (var k = 0; k < n; k++) c.fillRect(bx + 20 + k * 20, by + 5, 14, 4);
                            }
                            if (viz) {
