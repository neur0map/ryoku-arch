...
ColumnLayout {
  ...
  property string currentVersion: "Ryoku runtime"
  ...
  readonly property bool isUpToDate: false
  readonly property bool qsUpdateAvailable: false
  readonly property bool qsIsUpToDate: false
  ...
  function getTelemetryPayload() {
    ...
    return {
      instanceId: "ryoku-noctalia-runtime",
  ...
  GridLayout {
    ...
    NButton {
      ...
      onClicked: {
        ...
        ToastService.showNotice(I18n.tr("panels.about.changelog"), "Changelog is not available in the Ryoku runtime");
      }
    }
