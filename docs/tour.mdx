...
input, and window layout; the Ryoku shell paints the topbar, sidebars, lock
screen, launcher, and settings surfaces.
...
- **OpenVPN:** pick a profile and toggle the tunnel. See [plugins](/docs/plugins).
