...
- **OpenVPN** — pick a profile and toggle the tunnel. See [security tools](security-tools).
...
- [Keybindings](keybindings) — the full shipped reference.
- [Customize](customize) — themes, wallpapers, bar items.
- [Security tools](security-tools) — OpenVPN, Tailscale, SecPulse, polkit.
