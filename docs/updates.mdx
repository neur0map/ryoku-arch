...
Ryoku is rolling. The shell, theme pipeline, and Hyprland config are pulled from the `main` branch of [`neur0map/ryoku-arch`](https://github.com/neur0map/ryoku-arch). The Arch package set is rolling too.
