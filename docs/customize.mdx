...
- Use `Mod+,` to open Settings and the **Keybindings** tab there for the documented shipped binding baseline.
...
- **Shell config (raw JSON):** `~/.config/ryoku-shell/config.json`. Settings writes here; you can hand-edit when you know what you want.
