...
- See the [keybindings](keybindings) reference for what's bound today.
...
- **Theme palette overrides** — `~/.config/matugen/templates/` and `~/.local/state/quickshell/user/generated/`. See [`docs/branding.md`](branding) for the brand-color anchors.

The [customization inventory](customization-inventory) is the authoritative list of every text-based surface you can safely touch.
